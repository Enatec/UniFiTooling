...
online version: https://github.com/Enatec/UniFiTooling/raw/master/docs/Get-UnifiLoginSessions.md
schema: 2.0.0
---
...
```
Get-UnifiLoginSessions [[-UnifiSite] <String>] [[-Start] <String>] [[-End] <String>] [<CommonParameters>]
```
